...
describe('Event Management Tools', () => {
  ...
  describe('schedule_event', () => {
    ...
    it('should schedule a new event', async () => {
      registerScheduleEvent(mockServer);
      const handler = (mockServer.registerTool as any).mock.calls.find((c: any) => c[0] === 'schedule_event')[2];
      ...
      expect(result.content[0].text).toContain(`Event "${eventInput.name}" (${eventInput.type}) scheduled successfully`);
  ...
  describe('get_events', () => {
    ...
    const mockEvents: Event[] = [
      { id: 'e1', type: 'planning', name: 'Past Planning', startTime: '2025-11-01T10:00:00Z', endTime: '2025-11-01T11:00:00Z', notificationSent: false },
      { id: 'e2', type: 'stand-up', name: 'Today Standup', startTime: '2025-12-02T09:00:00Z', endTime: '2025-12-02T11:00:00Z', notificationSent: false }, // Changed endTime
      { id: 'e3', type: 'review', name: 'Future Review', startTime: '2025-12-15T14:00:00Z', endTime: '2025-12-15T15:00:00Z', notificationSent: false },
    ];
    ...
    it('should list all events', async () => {
      ...
      registerGetEvents(mockServer);
      const handler = (mockServer.registerTool as any).mock.calls.find((c: any) => c[0] === 'get_events')[2];
