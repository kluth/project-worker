    ...
    'schedule_event',
    {
      ...
      inputSchema: z.object({
        ...
        startTime: z
          .string()
          .datetime()
          .describe('Start time of the event (ISO 8601 format, e.g., "2024-12-01T09:00:00Z").'),
        endTime: z.string().datetime().describe('End time of the event (ISO 8601 format).'),
        attendees: z
          .array(z.string())
          .optional()
          .describe('List of attendees (e.g., user IDs or names).'),
        ...
        location: z
          .string()
          .optional()
          .describe('Location of the event (e.g., "Zoom Link", "Meeting Room A").'),
      }).shape,
    },
    async ({
      type,
